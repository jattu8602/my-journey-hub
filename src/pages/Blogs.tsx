...
const blogPosts: BlogPost[] = [
  ...
  {
    id: '9',
    slug: 'ai-adjacent-concepts',
    title: 'AI-Adjacent Concepts',
    excerpt: 'Understanding vector databases, embeddings, RAG architecture, and inference optimization — AI concepts without heavy math.',
    date: 'December 22, 2024',
    readTime: '35 min read',
  ...
  },
  {
    ...
    excerpt: 'Deep dive into the event loop, V8 engine internals, JIT compilation, hidden classes, and Node.js libuv architecture.',
    date: 'December 22, 2024',
    readTime: '35 min read',
  ...
  {
    id: '11',
    slug: 'builder-mindset',
    title: 'Builder-Mindset Topics',
    excerpt: 'Search engines, recommendation systems, real-time collaboration (CRDTs), and feature flags — portfolio gold for developers.',
    date: 'December 22, 2024',
    readTime: '40 min read',
    image: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=600&h=400&fit=crop',
    tags: ['Portfolio', 'Systems', 'Projects'],
  },
];
