import { ArrowLeft, Clock, Calendar, Database, Network, Shield, Server } from "lucide-react";
          ...
          <article className="prose prose-invert max-w-none">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-2 text-primary mb-4">
                <span className="text-sm font-medium uppercase tracking-wider">Backend Engineering</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                Backend & Distributed Systems
                <span className="block text-primary mt-2">Scalable Architecture</span>
              </h1>
            ...
            <section id="event-driven" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Event-Driven Architecture</h2>
              ...
              <section id="kafka-thinking" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Kafka-Style Thinking</h3>
...
class PaymentConsumer {
  async handleOrderCreated(event: OrderEvent): Promise<void> {
    ...
    await this.publishPaymentCompleted(event.data.orderId);
              ...
              <section id="async-systems" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Async Systems</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
await queue.process(async (job) => {
  if (job.type === 'send_email') {
    await sendEmail(job.payload);
              ...
              <section id="event-sourcing" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Event Sourcing</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
Complete audit trail! Can replay to any point in time.`}
            ...
            <section id="consistency" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Consistency Models</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              <section id="strong-eventual" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Strong vs Eventual Consistency</h3>
...
async function readYourWrites(
  ...
  return await readFromNode('primary', key);
              ...
              <section id="cap-theorem" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">CAP Theorem (Practical View)</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
AP (Availability + Partition Tolerance):
  ...
  - Examples: Cassandra, DynamoDB, CouchDB`}
              ...
              <section id="real-world-tradeoffs" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Real-World Tradeoffs</h3>
            ...
            <section id="rate-limiting" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Rate Limiting Algorithms</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              <section id="token-bucket" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Token Bucket</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
  ...
  if (bucket.tryAcquire()) {
    ...
    res.status(429).json({
      ...
      retryAfter: bucket.getState().resetIn
              ...
              <section id="leaky-bucket" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Leaky Bucket</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
app.post('/api/expensive-operation', async (req, res) => {
  ...
  res.json({ status: 'Processing' });
              ...
              <section id="sliding-window" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Sliding Window</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
  ...
  async isAllowed(userId: string): Promise<boolean> {
    ...
    return count < this.limit;
            ...
            <section id="idempotency" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Idempotency in APIs</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              <section id="why-idempotency" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Why Payment Systems Never Double-Charge</h3>
...
Customer charged exactly $100! ✓`}
              ...
              <section id="implementing-idempotency" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Implementing Idempotency</h3>
            ...
            <section id="resources" className="mb-16">
              ...
              <div className="p-6 rounded-xl border border-accent/30 bg-accent/5 mb-6">
                ...
                <ul className="text-muted-foreground space-y-3">
                  <li className="flex gap-2">
                    ...
                    <span><strong>"Designing Data-Intensive Applications"</strong> — Martin Kleppmann (the bible)</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-medium">2.</span>
                    <span><strong>"Building Microservices"</strong> — Sam Newman</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-medium">3.</span>
                    <span><strong>"Stripe API Idempotency"</strong> — stripe.com/docs</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-medium">4.</span>
                    <span><strong>"Kafka: The Definitive Guide"</strong> — Neha Narkhede et al.</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-6 rounded-xl border border-border/50 bg-card/50 mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-foreground font-bold block mb-2">Beginner:</span>
                  ...
                  <div>
                    <span className="text-foreground font-bold block mb-2">Advanced:</span>
                    <ul className="text-muted-foreground list-disc list-inside">
