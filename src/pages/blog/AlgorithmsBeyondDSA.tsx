          ...
          <article className="prose prose-invert max-w-none">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-2 text-primary mb-4">
                <span className="text-sm font-medium uppercase tracking-wider">Distributed Systems</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                Algorithms Beyond DSA Sheets
                <span className="block text-primary mt-2">Real-World Algorithms</span>
              </h1>
            ...
            <section id="probabilistic-ds" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Probabilistic Data Structures</h2>
              ...
              <section id="bloom-filters" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Bloom Filters</h3>
                <p className="text-muted-foreground mb-6">
...
bloom.mightContain("xyz");    // might be true (false positive)`}
              ...
              <section id="count-min-sketch" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Count-Min Sketch</h3>
...
sketch.estimate("/contact"); // ~0 (never visited)`}
              ...
              <section id="hyperloglog" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">HyperLogLog</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
hll.count(); // ~100000 (with small error)`}
            ...
            {/* Amortized Analysis */}
            <section id="amortized-analysis" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Amortized Analysis</h2>
              ...
              <section id="dynamic-arrays" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Why Dynamic Arrays Are Fast</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
// Total copies ≈ 2000, so ~2 copies per element on average`}
              ...
              <section id="real-vs-worst" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Real Cost vs Worst Case</h3>
            ...
            {/* Consistent Hashing */}
            <section id="consistent-hashing" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Consistent Hashing</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
...
ch.addNode("server-4");`}
              ...
              <section id="virtual-nodes" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Virtual Nodes</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            {/* Skip Lists */}
            <section id="skip-lists" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Skip Lists</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              <section id="skip-list-structure" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Structure & Operations</h3>
...
Average O(log n) because we skip half the elements at each level`}
              ...
              <section id="skip-list-implementation" className="mb-12">
...
skipList.delete(18); // true`}
            ...
            <section id="real-world-uses" className="mb-16">
            ...
            <section id="resources" className="mb-16">
              ...
              <div className="p-6 rounded-xl border border-primary/20 bg-primary/5 mb-6">
                <h4 className="font-bold text-foreground mb-4">📚 Further Reading</h4>
                <ul className="text-muted-foreground space-y-3">
                  <li className="flex gap-2">
                    <span className="text-primary font-medium">1.</span>
                    <span><strong>"Probabilistic Data Structures"</strong> — Redis University (free course)</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-medium">2.</span>
                    <span><strong>"Designing Data-Intensive Applications"</strong> — Martin Kleppmann</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-medium">3.</span>
                    <span><strong>"Skip Lists: A Probabilistic Alternative"</strong> — William Pugh (original paper)</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-medium">4.</span>
                    <span><strong>"Consistent Hashing and Random Trees"</strong> — Karger et al. (original paper)</span>
                  </li>
                </ul>
              </div>

              <div className="p-6 rounded-xl border border-border/50 bg-card/50 mb-6">
                <h4 className="font-bold text-foreground mb-4">🛠️ Try Them Yourself</h4>
                <div className="grid md:grid-cols-2 gap-6 text-sm">
                  <div>
                    <span className="text-foreground font-bold block mb-2">Libraries:</span>
                  ...
                  <div>
                    <span className="text-foreground font-bold block mb-2">Practice:</span>
                    <ul className="text-muted-foreground list-disc list-inside">
