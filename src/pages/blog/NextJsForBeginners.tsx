            ...
            <main className="flex-1 max-w-3xl">
              ...
              <header className="mb-12">
                ...
                <h1 className="text-4xl md:text-5xl font-display font-bold mb-6 leading-tight">
                  Next.js for Beginners<span className="text-accent">.</span>
                </h1>
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <section id="what-is-nextjs" className="mb-12">
                  <h2 className="text-2xl font-display font-bold text-foreground mb-4 flex items-center gap-2">
                    <span className="text-accent">#</span> What is Next.js?
                  </h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <section id="why-nextjs" className="mb-8">
                    <h3 className="text-xl font-display font-bold text-foreground mb-3">Why Next.js?</h3>
                    <p className="text-muted-foreground leading-relaxed">
...
Would you like to customize the default import alias? No`}
                  ...
                  <section id="project-structure" className="mb-8">
                    <h3 className="text-xl font-display font-bold text-foreground mb-3">Project Structure</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
...
└── package.json`}
                ...
                <section id="routing" className="mb-12">
                  <h2 className="text-2xl font-display font-bold text-foreground mb-4 flex items-center gap-2">
                    <span className="text-accent">#</span> Routing in Next.js
                  </h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <section id="file-based-routing" className="mb-8">
                    <h3 className="text-xl font-display font-bold text-foreground mb-3">File-based Routing</h3>
  ...
  return (
    <div>
      ...
      <p>Welcome to our website!</p>
                  ...
                  <section id="dynamic-routes" className="mb-8">
                    <h3 className="text-xl font-display font-bold text-foreground mb-3">Dynamic Routes</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
...
// /blog/nextjs-tutorial → params.slug = "nextjs-tutorial"`}
                ...
                <section id="components" className="mb-12">
                  ...
                  <section id="server-client" className="mb-8">
                    <h3 className="text-xl font-display font-bold text-foreground mb-3">Server vs Client Components</h3>
                    <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    <button onClick={() => setCount(count + 1)}>
      Count: {count}
                ...
                <section id="data-fetching" className="mb-12">
                  <h2 className="text-2xl font-display font-bold text-foreground mb-4 flex items-center gap-2">
                    <span className="text-accent">#</span> Data Fetching
                  </h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
...
\`User: \${user.name}, Role: \${user.role}\``}
                ...
                <section id="styling" className="mb-12">
                  <h2 className="text-2xl font-display font-bold text-foreground mb-4 flex items-center gap-2">
                    <span className="text-accent">#</span> Styling
                  </h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
...
# Or connect your GitHub repo to Vercel for automatic deployments`}
                ...
                <section id="conclusion" className="mb-12">
                  <h2 className="text-2xl font-display font-bold text-foreground mb-4 flex items-center gap-2">
                    <span className="text-accent">#</span> Conclusion
                  </h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  <div className="p-6 rounded-xl border border-accent/30 bg-accent/5">
                    <h4 className="font-display font-bold text-foreground mb-2">📚 Resources</h4>
