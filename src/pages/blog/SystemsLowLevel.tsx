          ...
          <article className="prose prose-invert max-w-none">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-2 text-primary mb-4">
                <span className="text-sm font-medium uppercase tracking-wider">Systems Programming</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                Systems & Low-Level Thinking
                <span className="block text-primary mt-2">Optimization Guide</span>
              </h1>
            ...
            <section id="introduction" className="mb-16">
              ...
              <section id="why-low-level" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Why Learn Low-Level?</h3>
            ...
            {/* Memory Models */}
            <section id="memory-models" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Memory Models</h2>
              ...
              <section id="stack-vs-heap" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Stack vs Heap</h3>
...
Low Address`}
              ...
              <section id="how-malloc-works" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">How malloc/new Actually Works</h3>
...
void my_free(void* ptr) {
    ...
    // Could also coalesce adjacent free blocks here
              ...
              <section id="fragmentation" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Memory Fragmentation</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
// Pre-allocates objects of specific sizes`}
              ...
              <section id="cache-locality" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Cache Locality</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
"Row-major cache loads: " + rowMajorCacheLoads.toLocaleString() + "\\nColumn-major cache loads: " + colMajorCacheLoads.toLocaleString() + "\\nDifference: " + (colMajorCacheLoads / rowMajorCacheLoads).toFixed(0) + "x more loads!";`}
            ...
            {/* CPU Caches */}
            <section id="cpu-caches" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">CPU Caches</h2>
              ...
              <section id="cache-hierarchy" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Cache Hierarchy (L1/L2/L3)</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div className="p-4 rounded-lg border border-border/50 bg-card/50 my-6">
                  ...
                  <pre className="text-sm font-mono text-muted-foreground overflow-x-auto pb-2">
              ...
              <section id="cache-friendly" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Cache-Friendly Algorithms</h3>
...
// Same O(n³) but 5-10x faster for large matrices!`}
              ...
              <section id="false-sharing" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">False Sharing</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
// Benchmark difference: 10-100x slower with false sharing!`}
              ...
              <section id="arrays-vs-linked" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Why Arrays Beat Linked Lists</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
// - Usually: just use std::vector / ArrayList`}
            ...
            {/* Threading */}
            <section id="threading" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Thread Scheduling</h2>

              <section id="context-switching" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Context Switching</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
// I/O-bound work: threads = cores * 2 (or more)`}
              ...
              <section id="why-threads-slow" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Why Multithreading Can Be Slower</h3>
...
results.join('\\n') + '\\n\\nMax theoretical: ' + (1/(1-parallel)).toFixed(0) + 'x';`}
              ...
              <section id="scheduling-types" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Cooperative vs Preemptive Scheduling</h3>
...
int main() {
    ...
    // OS scheduler handles everything
            ...
            <section id="lock-free" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Lock-Free Programming</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              <section id="atomic-operations" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Atomic Operations</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
void consumer() {
    ...
    assert(data == 42);  // Guaranteed!
              ...
              <section id="compare-and-swap" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Compare-and-Swap (CAS)</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    void push(T value) {
        ...
        do {
            ...
            newHead = {newNode, oldHead.tag + 1};
              ...
              <section id="why-locks-slow" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Why Locks Kill Performance</h3>
...
// - Correctness: Locks are much easier to reason about`}
            ...
            <section id="practical-tips" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Practical Optimization Tips</h2>
            ...
            <section id="resources" className="mb-16">
              ...
              <div className="p-6 rounded-xl border border-accent/30 bg-accent/5 mb-6">
                ...
                <ul className="text-muted-foreground space-y-3">
                  <li>
                    <span className="text-primary font-medium">"What Every Programmer Should Know About Memory"</span>
                    <span className="text-sm ml-2">— Ulrich Drepper (free PDF)</span>
                  </li>
                  <li>
                    <span className="text-primary font-medium">"C++ Concurrency in Action"</span>
                    <span className="text-sm ml-2">— Anthony Williams</span>
                  </li>
                  <li>
                    <span className="text-primary font-medium">"Computer Systems: A Programmer's Perspective"</span>
                    <span className="text-sm ml-2">— Bryant & O'Hallaron</span>
                  </li>
                  <li>
                    <span className="text-primary font-medium">"The Art of Multiprocessor Programming"</span>
