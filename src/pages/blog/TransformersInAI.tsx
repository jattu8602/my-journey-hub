          ...
          <article className="prose prose-invert max-w-none">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-2 text-primary mb-4">
                <span className="text-sm font-medium uppercase tracking-wider">Artificial Intelligence</span>
              </div>
            ...
            <section id="introduction" className="mb-16">
              ...
              <section id="history" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">History & Background</h3>
                ...
                <div id="attention-is-all-you-need" className="mb-8">
                  <h4 className="text-xl font-bold mb-3">Attention Is All You Need</h4>
                  <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="architecture" className="mb-16">
              ...
              <section id="self-attention" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Self-Attention Mechanism</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
def softmax(x):
    ...
    def forward(self, query, key, value, mask=None):
        ...
        return self.W_o(output)`}
              ...
              <section id="positional-encoding" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Positional Encoding</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
print(f"Shape: {pe.shape}")  # (100, 512)`}
              ...
              <section id="encoder-decoder" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Encoder-Decoder Structure</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    def forward(self, x):
        return self.linear2(self.activation(self.linear1(x)))`}
            ...
            <section id="key-concepts" className="mb-16">
              ...
              <section id="tokenization" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Tokenization</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
tokens.join(' → ');`}
              ...
              <section id="embeddings" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Embeddings</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
print(f"Output shape: {vectors.shape}")  # (6, 768)`}
            ...
            <section id="popular-models" className="mb-16">
              ...
              <section id="bert" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">BERT (Bidirectional Encoder Representations from Transformers)</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section id="gpt" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">GPT Series (Generative Pre-trained Transformer)</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section id="claude" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Claude (Anthropic)</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section id="implementation" className="mb-16">
              ...
              <section id="browser-transformers" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Transformers in the Browser</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
// ]`}
              ...
              <section id="api-usage" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Using AI APIs</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
await simulateAPICall("Hello");`}
            ...
            {/* Fine-Tuning */}
            <section id="fine-tuning" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Fine-Tuning</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
