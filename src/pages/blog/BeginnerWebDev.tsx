          ...
          <article className="prose prose-invert max-w-none">
            ...
            <div className="mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                ...
                <span className="block text-primary mt-2">The Essentials</span>
              </h1>
            ...
            <section id="introduction" className="mb-16">
              ...
              <section id="how-web-works" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">How the Web Works</h3>
              ...
              <section id="tools-setup" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Tools & Setup</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            {/* HTML Basics */}
            <section id="html-basics" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">HTML Basics</h2>
              ...
              <section id="html-structure" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">HTML Structure</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
<body>
    ...
    <script src="script.js"></script>
              ...
              <section id="html-elements" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Common HTML Elements</h3>
...
Object.entries(elements)
  ...
  .join('\\n');`}
              ...
              <section id="semantic-html" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Semantic HTML</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
<div class="footer">...</div>`}
              ...
              <section id="html-forms" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Forms & Inputs</h3>
    ...
    <button type="submit">Submit</button>
            ...
            {/* CSS Fundamentals */}
            <section id="css-fundamentals" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">CSS Fundamentals</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              <section id="css-selectors" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Selectors & Properties</h3>
...
.quote::after {
    content: '"';
              ...
              <section id="box-model" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">The Box Model</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
.card {
    flex: 1 1 300px;  /* grow | shrink | basis */
              ...
              <section id="css-grid" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">CSS Grid</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
    ...
    gap: 1rem;
                ...
                <div className="p-4 rounded-lg border border-border/50 bg-card/50 my-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-success font-bold">Flexbox</span>
                      <p className="text-muted-foreground">One dimension (row OR column). Great for navbars, cards in a row.</p>
                    </div>
                    <div>
                      <span className="text-success font-bold">Grid</span>
...
@media (min-width: 768px) {
    ...
    .desktop-only { display: block; }
            ...
            <section id="javascript-essentials" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">JavaScript Essentials</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              <section id="variables-types" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Variables & Data Types</h3>
...
message;`}
              ...
              <section id="functions" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Functions</h3>
...
Discounted (>50): \${discounted.join(", ")}\`;`}
              ...
              <section id="arrays-objects" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Arrays & Objects</h3>
...
const nickname = user.nickname ?? "No nickname";  // "No nickname"`}
              ...
              <section id="dom-manipulation" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">DOM Manipulation</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
element.parentNode.removeChild(element);`}
              ...
              <section id="events" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Event Handling</h3>
...
button.removeEventListener("click", handler);`}
            ...
            <section id="project-ideas" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Project Ideas</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
    ...
    <script>
        ...
        button.addEventListener('click', () => {
            ...
            <section id="resources" className="mb-16">
              ...
              <div className="p-6 rounded-xl border border-primary/20 bg-primary/5 mb-6">
                <h4 className="font-bold text-foreground mb-4">📚 Learning Platforms</h4>
              ...
              <div className="p-6 rounded-lg border border-border/50 bg-card/50">
                <h4 className="font-bold text-foreground mb-4">🚀 What's Next?</h4>
                <p className="text-muted-foreground mb-4">
                  Once you're comfortable with the basics, explore:
                </p>
                <div className="flex flex-wrap gap-2 text-sm">
                  <span className="px-3 py-2 rounded bg-secondary">React</span>
                  <span className="px-3 py-2 rounded bg-secondary">TypeScript</span>
                  <span className="px-3 py-2 rounded bg-secondary">Tailwind CSS</span>
                  <span className="px-3 py-2 rounded bg-secondary">Node.js</span>
                  <span className="px-3 py-2 rounded bg-secondary">Git & GitHub</span>
                  <span className="px-3 py-2 rounded bg-secondary">APIs</span>
                  <span className="px-3 py-2 rounded bg-secondary">Databases</span>
                  <span className="px-3 py-2 rounded bg-secondary">Deployment</span>
                </div>
              </div>

              <BlogNote type="success">
