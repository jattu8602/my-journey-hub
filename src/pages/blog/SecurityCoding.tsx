import { ArrowLeft, Clock, Calendar, Shield, Lock, Key, AlertTriangle } from "lucide-react";
          ...
          <article className="prose prose-invert max-w-none">
            ...
            <div className="mb-12">
              <div className="flex items-center gap-2 text-primary mb-4">
                <span className="text-sm font-medium uppercase tracking-wider">Web Security</span>
              </div>
            ...
            <section id="auth-internals" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Authentication Internals</h2>
              ...
              <section id="jwt-vs-sessions" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">JWT vs Sessions</h3>
...
try {
  ...
  if (error.name === 'TokenExpiredError') {
    ...
    // Invalid signature - tampered or wrong secret
              ...
              <section id="refresh-tokens" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Refresh Tokens</h3>
...
async function authMiddleware(req, res, next) {
  ...
  try {
    ...
    return res.status(401).json({ error: 'Invalid token' });
              ...
              <section id="rotation-strategies" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Token Rotation Strategies</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
  ...
  async refresh(refreshToken: string): Promise<TokenPair> {
    ...
    return {
      ...
      refreshToken: newRefreshToken,
            ...
            {/* Web Attacks */}
            <section id="web-attacks" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">Web Attack Simulations</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              <section id="sql-injection" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">SQL Injection</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
results.join('\\n');`}
              ...
              <section id="csrf" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">CSRF (Cross-Site Request Forgery)</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
app.use((req, res, next) => {
  ...
  next();
              ...
              <section id="xss" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">XSS (Cross-Site Scripting)</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
results.join('\\n');`}
            ...
            {/* OAuth 2.0 */}
            <section id="oauth2" className="mb-16">
              <h2 className="text-3xl font-bold mb-6">OAuth 2.0 Internals</h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              <section id="auth-code-flow" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">Authorization Code Flow</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
app.get('/auth/google/callback', async (req, res) => {
  ...
  try {
    ...
    res.redirect('/login?error=oauth_failed');
              ...
              <section id="pkce" className="mb-12">
                <h3 className="text-2xl font-semibold mb-4">PKCE (Proof Key for Code Exchange)</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
...
function CallbackPage() {
  ...
  return <div>Processing login...</div>;
            ...
            {/* Security Checklist */}
            <section id="security-checklist" className="mb-16">
            ...
            <section id="resources" className="mb-16">
              ...
              <div className="p-6 rounded-xl border border-accent/30 bg-accent/5 mb-6">
                ...
                <ul className="text-muted-foreground space-y-3">
                  <li>
                    <span className="text-primary font-medium">"OWASP Top 10"</span>
                    <span className="text-sm ml-2">— The most critical web security risks</span>
                  </li>
                  <li>
                    <span className="text-primary font-medium">"OAuth 2.0 Simplified"</span>
                    <span className="text-sm ml-2">— Aaron Parecki (oauth.net)</span>
                  </li>
                  <li>
                    <span className="text-primary font-medium">"JWT Handbook"</span>
